...
### === 新增：选择编译目标 ===
# 如果需要编译 AX6s (mt7622/RB03)，拷贝对应 seed
if [ -f "../mt7622_ax6s_config.seed" ]; then
    echo "[INFO] Using mt7622_ax6s_config.seed for Xiaomi AX6s (RB03)"
    cp ../mt7622_ax6s_config.seed .config
    make defconfig
fi
